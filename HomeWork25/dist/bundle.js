...
function btnasveclick() {
  ...
  if (chack == "ADD") {
    ...
    var urlupdate = 'http://localhost:3000/books/' + BookId;
...
function deletecard(id) {
  ...
  if (r == true) {
    ...
    var urldelete = 'http://localhost:3000/books';
    fetch(urldelete + '/' + id, {
      method: 'delete'
    }).then(function (response) {
